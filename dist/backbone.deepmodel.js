...
"use strict";
/* harmony export */ exports["a"] = deepCopy;var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol ? "symbol" : typeof obj; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__object_path__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__deep_copy__ = __webpack_require__(0);
...
function updateObjectPath() {
  __WEBPACK_IMPORTED_MODULE_1__object_path__["a" /* default */].pathSeparator = _defaults.pathSeparator;

  var pathParser = _defaults.pathParser;
  if (typeof pathParser === 'function' || pathParser == null) {
    __WEBPACK_IMPORTED_MODULE_1__object_path__["a" /* default */].pathParser = pathParser;
  }

  return __WEBPACK_IMPORTED_MODULE_1__object_path__["a" /* default */];
}
  ...
  _createClass(DeepModel, [{
    ...
    value: function set(attribute, value, options) {
      ...
      var newAttrs = Object.keys(attrs).reduce(function (newObj, path) {
        ...
        if (obj == null) {
          obj = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__deep_copy__["a" /* default */])(_this2.attributes[rootPath]);
        }
        if (!isObject(obj)) {
    ...
    value: function extend() {
      ...
      return (_Backbone$Model2 = __WEBPACK_IMPORTED_MODULE_0_backbone___default.a.Model).extend.apply(_Backbone$Model2, arguments);
    }
...
/* harmony default export */ exports["default"] = DeepModel;
module.exports = exports['default'];
